...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
                ...
                builder: (context, puzzleCompleted, child) {
                  ...
                  return Center(
                    child: GestureDetector(
                      ...
                      onTap: () async {
                        if (disableButton) {
                          // Buton inaktifken sempatik uyarı mesajı gösterelim.
                          showDialog(
                            context: context,
                            builder: (context) {
                              return AlertDialog(
                                title: Text("Günlük Bulmaca"),
                                content: Text(
                                  "Bugünlük bulmaca maceran burada sona erdi. Endişelenme, yarın yepyeni bir bulmaca seni bekliyor! Şimdilik dinlen, yarın tekrar görüşmek üzere :)",
                    ...
                    children: [
                      ...
                      ValueListenableBuilder<int>(
                        ...
                        builder: (context, remainingLives, _) {
                          // Buton aktifliği, hem remainingLives hem de tüm bölümlerin tamamlanmamış olmasına bağlı
                          bool isPlayButtonActive = remainingLives > 0 && !GlobalProperties.allSectionsCompleted;
                          ...
                          return GestureDetector(
                            ...
                            onTap: () async {
                              if (!isPlayButtonActive) {
                                // Buton inaktif: Tüm bölümler tamamlandığı için veya canlar yetersiz olduğundan
                                showDialog(
                                  context: context,
                                  builder: (context) {
                                    return AlertDialog(
                                ...
                                // Buton aktif: Normal işlemleri gerçekleştir.
                                if (GlobalProperties.isSoundOn) {
                                  await _clickAudioPlayer?.stop();
  ...
  Future<void> loadGameData() async {
    ...
    GlobalProperties.allSectionsCompleted = prefs.getBool('allSectionsCompleted') ?? false;
