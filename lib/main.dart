                      ...
                      ValueListenableBuilder<int>(
                        ...
                        builder: (context, remainingLives, _) {
                          return GestureDetector(
                            ...
                            onTap: () async {
                              if (remainingLives > 0) {
                                // Canlar varsa normal işlemleri gerçekleştir.
                                if (GlobalProperties.isSoundOn) {
                                  await _clickAudioPlayer?.stop();
                                  await _clickAudioPlayer?.play(
                                    AssetSource('audios/click_audio.mp3'),
                                ...
                                // Canlar bitmişse kullanıcıya mesaj göster.
                                showDialog(
                                  context: context,
                                  builder: (context) {
                                    return AlertDialog(
                                      title: Text("Hadi Biraz Nefes Al!"),
                                      content: Text(
                                        "Maalesef canların bitmiş görünüyor. Canların yenilendiğinde tekrar gel ve heyecanlı bulmacalarla devam edelim!",
                                        style: GlobalProperties.globalTextStyle(color: Colors.black),
                                      ),
                                      actions: [
                                        TextButton(
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          package: Icons.play_arrow.fontPackage,
                                          fontSize: 60,
                                          // İsteğe bağlı: Can kalmadığında ikon rengini de değiştirebilirsiniz.
                                          color: remainingLives > 0 ? Colors.white : Colors.black38,
                                          shadows: [
                                            Shadow(
                                              offset: Offset(2, 2),
                                              blurRadius: 4,
