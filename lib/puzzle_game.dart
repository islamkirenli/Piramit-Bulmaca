...
class _PuzzleGameState extends State<PuzzleGame> with WidgetsBindingObserver, SingleTickerProviderStateMixin {
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          height: 50,
                          decoration: BoxDecoration(
                            color: Colors.black.withOpacity(0.6), // Daha şeffaf siyah arka plan
                            shape: BoxShape.circle,               // Daire şekli
                            border: Border.all(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${puzzleSections[currentMainSection]![currentSubSection]![currentIndex]['word']!.length * 100}',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 10,
  ...
  void showWordHint(){
    setState(() {
      // O an tahmin edilmesi gereken kelimenin harf sayısını al
      String currentWord = puzzleSections[currentMainSection]![currentSubSection]![currentIndex]['word']!;
      int cost = currentWord.length * 100; 

      // Coin yeterli mi kontrol et
      if (GlobalProperties.coin.value < cost) {
        showCoinPopup(context);
        return; // Popup gösterildikten sonra fonksiyonu sonlandır
      }
      ...
      // Mevcut kelimenin tüm indekslerini aç
      revealedIndexesForCurrentWord = List.generate(currentWord.length, (i) => i);

      // Kelimedeki tüm harfler açıldıysa "Doğru tahmin" akışını çalıştır
      feedbackMessage = "Doğru tahmin!";
      if (!correctWords.contains(currentWord)) {
        correctWords.add(currentWord);
      }
      ...
      // Eğer bu kelime son kelime değilse bir sonrakine geç
      if (currentIndex < puzzleSections[currentMainSection]![currentSubSection]!.length - 1) {
        currentIndex++;
        revealedIndexesForCurrentWord.clear();
        selectedLetters.clear();
        ...
        // Bölümdeki son kelime de tamamlandıysa
        revealedIndexesForCurrentWord.clear();
