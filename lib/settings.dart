      ...
      children: [
        ...
        ElevatedButton.icon(
          onPressed: () async{
            ...
            final String email = 'piramitbulmaca@gmail.com';
            // Parametreler için encode işlemi yapıyoruz (boşluklar %20 olarak kodlanır)
            final String subject = Uri.encodeComponent("Öneri ve Destek");
            final String body = Uri.encodeComponent("Merhaba, öneri ve destek için şunları paylaşmak istiyorum:");
            // Mailto URI'sini manuel olarak oluşturuyoruz
            final Uri emailLaunchUri = Uri.parse('mailto:$email?subject=$subject&body=$body');

            try {
              await launchUrl(emailLaunchUri);
            } catch (e) {
              debugPrint('Mail gönderilemedi: $e');
            }
          },
          icon: Icon(Icons.mail, color: Colors.white), // Mail ikonu
          label: Text(
